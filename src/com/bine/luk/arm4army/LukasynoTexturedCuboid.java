 ...
 */
public class LukasynoTexturedCuboid {
	...
	private float vertices[] = {
			...
			-1.0f, 1.0f, -1.0f, 
			1.0f, 1.0f, -1.0f, };
	private float vertices4VerticalCuboid[] = {
			// Vertices according to faces
			-0.2f,
			-3.0f,
			0.2f, // Vertex 0
			...
			-3.0f,
			0.2f, // ...
			0.2f, -3.0f, -0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, -0.2f,

			0.2f, -3.0f, -0.2f, -0.2f, -3.0f, -0.2f, 0.2f, 0.2f, -0.2f, -0.2f,
			0.2f, -0.2f,

			-0.2f, -3.0f, -0.2f, -0.2f, -3.0f, 0.2f, -0.2f, 0.2f, -0.2f, -0.2f,
			0.2f, 0.2f, -0.2f, -3.0f, -0.2f, 0.2f, -3.0f, -0.2f, -0.2f, -3.0f,
			0.2f, 0.2f, -3.0f, 0.2f, -0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f,
	 ...
	 */
	public LukasynoTexturedCuboid(float[] CuboidSizes) {
		for (int i = 0; i < vertices.length; i++) {
			switch (i % 3) {
			case 0: {
				if (vertices[i] < 0)
					vertices[i] = CuboidSizes[0];
				else
					vertices[i] = CuboidSizes[1];
				break;
			}
			case 1: {
				if (vertices[i] < 0)
					vertices[i] = CuboidSizes[2];
				else
					vertices[i] = CuboidSizes[3];
				break;
			}
			case 2: {
				if (vertices[i] < 0)
					vertices[i] = CuboidSizes[4];
				else
					vertices[i] = CuboidSizes[5];
				break;
			}
			}
		}
